        ...
        <section className="card">
          ...
          <div className="veto-stepper">
            ...
            <button
              ...
              onClick={() => send({ type: "set_max_vetoes", count: maxVetoes - 1 })}
          ...
          <div className="lobby-settings">
            <label className="lobby-toggle">
              ...
              <input
                ...
                onChange={(e) => send({ type: "set_lobby_public", public: e.target.checked })}
              />
            </label>
            <label className="lobby-toggle">
              <span>Locked</span>
              <input
                ...
                onChange={(e) => send({ type: "set_lobby_locked", locked: e.target.checked })}
              />
            </label>
            <div className="lobby-password-row">
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    send({ type: "set_lobby_password", password: value || null });
              ...
              {state.lobby_has_password && (
                <button
                  ...
                  onClick={() => send({ type: "set_lobby_password", password: null })}
                >
                  Remove
                </button>
              )}
                ...
                <button
                  ...
                  onClick={() => {
                    if (window.confirm(`Kick ${player.name}?`)) {
                      send({ type: "kick_player", target_id: player.id });
                    }
                  }}
